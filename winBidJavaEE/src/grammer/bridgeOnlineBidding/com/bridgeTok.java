...
public static bridgeTokens[] mainTypes() {
 ...
 public static grammer.bridgeOnlineBidding.com.bridgeTokens  returnToken(String argTokS)
	...
	switch(chi)
	{
			...
			case 44: return grammer.bridgeOnlineBidding.com.bridgeTokens.DOUBLE_QUOTE;
...
public static void throwTokens(String argMsg, bridgeTokens tk, bridgeTokens[] argTokenA) throws bridgeParseException {
       ...
       public static String retTokValue(grammer.bridgeOnlineBidding.com.bridgeTokens tk) {
               // TODO Auto-generated method stub
               switch(tk)
               {
			case ACE: return "ACE";
	...
	return "";
       ...
       public static char retTokChar(grammer.bridgeOnlineBidding.com.bridgeTokens tk) {
               // TODO Auto-generated method stub
               switch(tk)
               {
