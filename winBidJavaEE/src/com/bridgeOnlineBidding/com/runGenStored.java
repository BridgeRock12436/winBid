...
public class runGenStored {
	...
	public static void main(String[] args) {
		...
		gen.bridgeOnlineBidding.com.genStoredProcedure allocObj;
		...
		while(listI.hasNext())
		{
			tblName=listI.next();
			try {
				allocObj=new gen.bridgeOnlineBidding.com.genStoredProcedure(tblName, dbObj);
